...
<body>
	...
	<div class="centro internas">
		<article>
			<h1 class="tituloazul">Eleições 2012, Londrina - Paraná</h1>
			<h2>Prefeito - Segundo Turno</h2>
			<table>
			...
			<a href="#" class="maisdetalhes fleft">Resultados de Vereadores</a>
		</article>
		<aside>
